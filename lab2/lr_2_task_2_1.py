...
Original file is located at
    https://colab.research.google.com/drive/1Y7940kQqhj8Up50ph4bK9WGGxAKzJGLZ
"""
...
for i, item in enumerate(input_data):
    if item.isdigit():
        ...
        try:
            ...
            input_data_encoded[i] = -1  # для нових категорій
        count += 1

# Перетворення у 2D масив
input_data_encoded = np.array(input_data_encoded).reshape(1, -1)

# Нормалізація тестової точки
