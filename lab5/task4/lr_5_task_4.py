...
Original file is located at
    https://colab.research.google.com/drive/1H0-X3d6OEuJUW93xIBm2tWgGM-wKSdnh
"""
...
# Модель на основі регресорpa AdaBoost
regressor = AdaBoostRegressor(
    DecisionTreeRegressor(max_depth=4),
    n_estimators=400, random_state=7)
regressor.fit(X_train, y_train)

# Обчислення показників ефективності регресopa AdaBoost
