...
Original file is located at
    https://colab.research.google.com/drive/1QrS72k59oNiXDcVEqAVKckblUTp-ziDI
"""
...
sys.argv = ['notebook', '--classifier-type', 'erf']
...
def build_arg_parser():
  ...
  dest='classifier_type', required=True, choices=['rf', 'erf'], help="Type of classifier to use; can be either 'rf' or 'erf'")
  return parser
